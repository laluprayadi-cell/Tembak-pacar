...
<head>
<meta charset="UTF-8">
<title>Ultimate Mini Game Gebetan 💖</title>
...
<div class="card">
  ...
  <button class="yes" id="yesBtn">💖 MAU</button>
  <button class="no" id="noBtn">🙂 TIDAK</button>

  <div id="result"></div>
  <a id="waBtn" class="wa-btn" target="_blank">📲 Kirim ke WhatsApp</a>
  <div id="noMsg"></div>
</div>
...
<script>
const messages = [
  "Eh jangan dong 😏","Ayo dong, jangan gitu 🥺","Aku sayang kamu loh 💕",
  "Coba pikir lagi 😘","Nggak lucu deh 😅","Sayang banget kalau nggak mau 😍",
  "Aduh, jangan kabur 🥰","Hati-hati, aku cemburu 😳",
  "Boleh dong, please 🥺","Jangan pergi, aku butuh kamu 💖"
];
...
yesBtn.addEventListener('click',()=>{
  ...
  result.innerHTML="Yeaay 🥰 Kamu resmi jadi pacarku ❤️";
  result.style.opacity=1;
  const wa=document.getElementById('waBtn');
  wa.href="https://wa.me/6281234567890?text=Aku%20MAU%20jadi%20pacar%20kamu%20❤️";
  wa.style.opacity=1;
  simpleConfetti(50);
  heartExplosion(30);
